...
package com.krrishdholakia.community_reporting.application.clustering;
...
import com.krrishdholakia.community_reporting.application.clustering.algo.Algorithm;
import com.krrishdholakia.community_reporting.application.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.krrishdholakia.community_reporting.application.clustering.algo.PreCachingAlgorithmDecorator;
import com.krrishdholakia.community_reporting.application.clustering.view.ClusterRenderer;
import com.krrishdholakia.community_reporting.application.clustering.view.DefaultClusterRenderer;
 ...
 * <p/>
 * ClusterManager should be added to the map as an: <ul> <li>{@link GoogleMap.OnCameraIdleListener}</li>
 * <li>{@link GoogleMap.OnMarkerClickListener}</li> </ul>
 */
public class ClusterManager<T extends ClusterItem>  implements
    ...
    public ClusterManager(Context context, GoogleMap map, MarkerManager markerManager) {
        ...
        mRenderer =  new DefaultClusterRenderer<T>();
     ...
     */
    private class ClusterTask extends AsyncTask<Float, Void, Set<? extends com.krrishdholakia.community_reporting.application.clustering.Cluster<T>>> {
        @Override
        protected Set<? extends com.krrishdholakia.community_reporting.application.clustering.Cluster<T>> doInBackground(Float... zoom) {
            mAlgorithmLock.readLock().lock();
            try {
                return (Set<? extends Cluster<T>>) mAlgorithm.getClusters(zoom[0]);
            } finally {
        ...
        @Override
        protected void onPostExecute(Set<? extends com.krrishdholakia.community_reporting.application.clustering.Cluster<T>> clusters) {
    ...
    public void setOnClusterClickListener(OnClusterClickListener<T> listener) {
        ...
        mRenderer.setOnClusterClickListener((com.krrishdholakia.community_reporting.application.clustering.ClusterManager.OnClusterClickListener<T>) listener);
    }
    ...
    public void setOnClusterInfoWindowClickListener(OnClusterInfoWindowClickListener<T> listener) {
        ...
        mRenderer.setOnClusterInfoWindowClickListener((com.krrishdholakia.community_reporting.application.clustering.ClusterManager.OnClusterInfoWindowClickListener<T>) listener);
    }
    ...
    public void setOnClusterItemClickListener(OnClusterItemClickListener<T> listener) {
        ...
        mRenderer.setOnClusterItemClickListener((com.krrishdholakia.community_reporting.application.clustering.ClusterManager.OnClusterItemClickListener<T>) listener);
    }
    ...
    public void setOnClusterItemInfoWindowClickListener(OnClusterItemInfoWindowClickListener<T> listener) {
        ...
        mRenderer.setOnClusterItemInfoWindowClickListener((com.krrishdholakia.community_reporting.application.clustering.ClusterManager.OnClusterItemInfoWindowClickListener<T>) listener);
    }

    /**
     * Called when a Cluster is clicked.
     */
    public interface OnClusterClickListener<T extends com.krrishdholakia.community_reporting.application.clustering.ClusterItem> {
        public boolean onClusterClick(com.krrishdholakia.community_reporting.application.clustering.Cluster<T> cluster);
    }

    /**
     * Called when a Cluster's Info Window is clicked.
     */
    public interface OnClusterInfoWindowClickListener<T extends com.krrishdholakia.community_reporting.application.clustering.ClusterItem> {
        public void onClusterInfoWindowClick(com.krrishdholakia.community_reporting.application.clustering.Cluster<T> cluster);
    }

    /**
     * Called when an individual ClusterItem is clicked.
     */
    public interface OnClusterItemClickListener<T extends com.krrishdholakia.community_reporting.application.clustering.ClusterItem> {
