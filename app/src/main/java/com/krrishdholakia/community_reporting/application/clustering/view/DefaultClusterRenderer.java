...
package com.krrishdholakia.community_reporting.application.clustering.view;
...
import com.krrishdholakia.community_reporting.application.clustering.ClusterManager;
...
import static com.krrishdholakia.community_reporting.application.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;

/**
 * The default view for a ClusterManager. Markers are animated in and out of clusters.
 */
public class DefaultClusterRenderer<T extends ClusterItem> implements com.krrishdholakia.community_reporting.application.clustering.view.ClusterRenderer<T> {
 ...
 /*   public DefaultClusterRenderer(Context context, GoogleMap map, ClusterManager<T> clusterManager) {
    ...
    public DefaultClusterRenderer(Context context, GoogleMap map, com.community_reporting.community_reporting.com.community_reporting.application.clustering.ClusterManager<T> tClusterManager) {
    }
    */
