 ...
 */
public class PreCachingAlgorithmDecorator<T extends ClusterItem> implements com.krrishdholakia.community_reporting.application.clustering.algo.Algorithm<T> {
    private final com.krrishdholakia.community_reporting.application.clustering.algo.Algorithm<T> mAlgorithm;
    ...
    public PreCachingAlgorithmDecorator(com.krrishdholakia.community_reporting.application.clustering.algo.Algorithm<T> algorithm) {
