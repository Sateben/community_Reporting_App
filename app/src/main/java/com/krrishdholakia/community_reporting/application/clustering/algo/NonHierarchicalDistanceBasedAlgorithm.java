 ...
 */
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements com.krrishdholakia.community_reporting.application.clustering.algo.Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.krrishdholakia.community_reporting.application.clustering.algo.StaticCluster<T> cluster = new StaticCluster<T>(candidate.mClusterItem.getPosition());
                results.add(cluster);
